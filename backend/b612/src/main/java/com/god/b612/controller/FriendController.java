...
public class FriendController {
    ...
    public ResponseEntity<?>  getFriends(@ApiParam(value = "친구목록을 조회할 멤버 아이디", example = "0") @PathVariable("memberId")int memberId, @ApiParam(value = "Page 번호, 0부터 시작", example = "0") @PathVariable("page")int page,@PathVariable("size")int size){
    ...
    public ResponseEntity<?>  getUnresponsedFriends(@ApiParam(value = "친구목록을 조회할 멤버 아이디", example = "0") @PathVariable("memberId")int memberId, @ApiParam(value = "Page 번호, 0부터 시작", example = "0") @PathVariable("page")int page,@PathVariable("size")int size){
        PageRequest pageRequest=PageRequest.of(page,size);
    ...
    public ResponseEntity<?>  getRequestedFriends(@ApiParam(value = "친구목록을 조회할 멤버 아이디", example = "0") @PathVariable("memberId")int memberId, @ApiParam(value = "Page 번호, 0부터 시작", example = "0") @PathVariable("page")int page,@PathVariable("size")int size){
        PageRequest pageRequest=PageRequest.of(page,size);
