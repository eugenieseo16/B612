...
contract MintPlanetToken is ERC721Enumerable {
    ...
    string[] one = [unicode"당당한 ", unicode"웅장한 ", unicode"아름다운 ", unicode"쾌적한 ", unicode"완벽한 ", unicode"노란 ", unicode"청량한 ", unicode"담백한 ", unicode"긴박한 ",
     ...
     unicode"환상적인 ", unicode"매혹적인 ", unicode"유연한 ", unicode"조용한 ", unicode"건조한 ", unicode"흥미로운 ", unicode"확실한 ", unicode"장엄한 ", unicode"믿을 수 없는 ", 
    ...
    unicode"대왕", unicode"오징어", unicode"도롱뇽", unicode"도토리", unicode"두더지", unicode"라이언", unicode"라쿤", unicode"래서팬더", unicode"멍멍이", unicode"모래사장", 
    ...
    unicode"산양", unicode"산토끼", unicode"상어", unicode"상추", unicode"새우", unicode"샐러드", unicode"서리태", unicode"선인장", unicode"솔개", unicode"순록", unicode"딸기", 
    unicode"스케이트", unicode"비밀가든", unicode"아기돼지", unicode"아기사자", unicode"폭탄머리", unicode"아기토끼", unicode"알파카", unicode"열대어", unicode"여우", 
    unicode"여우비", unicode"염소", unicode"오리", unicode"왕관", unicode"왕자님", unicode"왕자비", unicode"왕푸", unicode"용", unicode"우편함", unicode"유니콘", 
    ...
    unicode"명쾌한 ", unicode"무대위의 ", unicode"문제해결 능력 있는 ", unicode"바쁜 ", unicode"발명가적인 ", unicode"배려하는 ", unicode"밝은 ", unicode"박력 있는 ", unicode"범용적인 ", 
    unicode"본능적인 ", unicode"부지런한 ", unicode"불가능한 ", unicode"불규칙한 ", unicode"비범한 ", unicode"빠른 ", unicode"사랑하는 ", unicode"살아있는 ", unicode"생동감 있는 ", 
    unicode"선명한 ", unicode"선실한 ", unicode"솔직한 ", unicode"수다쟁이 ", unicode"숨겨진 ", unicode"슬기로운 ", unicode"시크한 ", unicode"시원한 ", unicode"실력있는 ", 
    unicode"신비로운 ", unicode"신선한 ", unicode"신중한 ", unicode"신참의 ", unicode"실용적인 ", unicode"야심찬 ", unicode"어두운 ", unicode"어려운 ", unicode"여유로운 ", 
    unicode"역동적인 ", unicode"열정적인 ", unicode"예술적인 ", unicode"예쁜 ", unicode"예의 바른 ", unicode"완벽한 ", unicode"외향적인 ", unicode"용감한 ", unicode"우아한 ", 
    unicode"웃긴 ", unicode"유머있는 ", unicode"유명한 ", unicode"유연한 ", unicode"유익한 ", unicode"의지가 있는 ", unicode"자랑스러운 ", unicode"재능 있는 ", unicode"재치 있는 ", 
